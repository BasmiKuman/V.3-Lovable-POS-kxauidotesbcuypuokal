...
import { ShoppingCart, User, Package, DollarSign, Trash2, Plus, Minus, CheckCircle2 } from "lucide-react";
...
export default function ManualSales() {
  ...
  // Fetch products when rider selected
  useEffect(() => {
    if (selectedRider) {
      fetchRiderStock();
    } else {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const taxAmount = 0; // No tax for manual entry
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Pilih rider untuk melihat stock dan input penjualan</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <CardContent>
                  {loading ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-muted-foreground mt-2">Memuat stock...</p>
                    </div>
                  ) : products.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                      <Package className="w-12 h-12 mx-auto mb-2 opacity-50" />
                      <p>Rider tidak memiliki stock</p>
                    </div>
                  ) : (
              ...
              <CardContent>
                {cart.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm mt-1">Pilih produk dari daftar untuk menambahkan</p>
                  </div>
                ) : (
